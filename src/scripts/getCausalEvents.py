        ...
        for title in articles:
            ...
            for sentence in articles[title]:
                ...
                for i in range(len(dep)):
                    if 'because' not in words[i]:
                        continue

                    becauseIndex = words[i].index('because')
                    eventBatch = [[], []]
                    ...
                    for e in es:
                        ...
                        if e < becauseIndex:
                            ...
                            section = 1
                        eventBatch[section].append((predicateIndex,
                                                    tuple(argument_indices[0]), 
                                                    tuple(argument_indices[1]), 
                                                    tuple(argument_indices[2])))
                        '''
